...
.field private final zzasu:Z

.field private final zzasv:Lcom/google/android/gms/internal/zznv;
...
.method constructor <init>(ILjava/util/List;Ljava/util/List;ZLandroid/os/IBinder;)V
    ...
    iput-object p2, p0, Lcom/google/android/gms/fitness/request/DataSourcesRequest;->zzapW:Ljava/util/List;

    iput-object p3, p0, Lcom/google/android/gms/fitness/request/DataSourcesRequest;->zzast:Ljava/util/List;

    iput-boolean p4, p0, Lcom/google/android/gms/fitness/request/DataSourcesRequest;->zzasu:Z

    invoke-static {p5}, Lcom/google/android/gms/internal/zznv$zza;->zzbv(Landroid/os/IBinder;)Lcom/google/android/gms/internal/zznv;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/gms/fitness/request/DataSourcesRequest;->zzasv:Lcom/google/android/gms/internal/zznv;
...
.method private constructor <init>(Lcom/google/android/gms/fitness/request/DataSourcesRequest$Builder;)V
    ...
    invoke-static {v1}, Lcom/google/android/gms/internal/zzmj;->zza([I)[Ljava/lang/Integer;
    ...
    invoke-direct {p0, v0, v1, v2, v3}, Lcom/google/android/gms/fitness/request/DataSourcesRequest;-><init>(Ljava/util/List;Ljava/util/List;ZLcom/google/android/gms/internal/zznv;)V
...
.method public constructor <init>(Lcom/google/android/gms/fitness/request/DataSourcesRequest;Lcom/google/android/gms/internal/zznv;)V
    .locals 3
    .param p1, "request"    # Lcom/google/android/gms/fitness/request/DataSourcesRequest;
    .param p2, "callback"    # Lcom/google/android/gms/internal/zznv;

    .prologue
    iget-object v0, p1, Lcom/google/android/gms/fitness/request/DataSourcesRequest;->zzapW:Ljava/util/List;

    iget-object v1, p1, Lcom/google/android/gms/fitness/request/DataSourcesRequest;->zzast:Ljava/util/List;

    iget-boolean v2, p1, Lcom/google/android/gms/fitness/request/DataSourcesRequest;->zzasu:Z

    invoke-direct {p0, v0, v1, v2, p2}, Lcom/google/android/gms/fitness/request/DataSourcesRequest;-><init>(Ljava/util/List;Ljava/util/List;ZLcom/google/android/gms/internal/zznv;)V

    return-void
.end method

.method public constructor <init>(Ljava/util/List;Ljava/util/List;ZLcom/google/android/gms/internal/zznv;)V
    .locals 1
    .param p3, "includeDbOnlySources"    # Z
    .param p4, "callback"    # Lcom/google/android/gms/internal/zznv;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/util/List",
    ...
    iput-object p1, p0, Lcom/google/android/gms/fitness/request/DataSourcesRequest;->zzapW:Ljava/util/List;

    iput-object p2, p0, Lcom/google/android/gms/fitness/request/DataSourcesRequest;->zzast:Ljava/util/List;

    iput-boolean p3, p0, Lcom/google/android/gms/fitness/request/DataSourcesRequest;->zzasu:Z

    iput-object p4, p0, Lcom/google/android/gms/fitness/request/DataSourcesRequest;->zzasv:Lcom/google/android/gms/internal/zznv;
...
.method public getDataTypes()Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/google/android/gms/fitness/request/DataSourcesRequest;->zzapW:Ljava/util/List;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/google/android/gms/fitness/request/DataSourcesRequest;->zzapW:Ljava/util/List;
    ...
    iget-object v2, p0, Lcom/google/android/gms/fitness/request/DataSourcesRequest;->zzast:Ljava/util/List;

    invoke-virtual {v0, v1, v2}, Lcom/google/android/gms/common/internal/zzw$zza;->zzg(Ljava/lang/String;Ljava/lang/Object;)Lcom/google/android/gms/common/internal/zzw$zza;

    move-result-object v0

    iget-boolean v1, p0, Lcom/google/android/gms/fitness/request/DataSourcesRequest;->zzasu:Z
...
.method public zzsO()Landroid/os/IBinder;
    ...
    iget-object v0, p0, Lcom/google/android/gms/fitness/request/DataSourcesRequest;->zzasv:Lcom/google/android/gms/internal/zznv;
...
.method public zzsX()Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object v0, p0, Lcom/google/android/gms/fitness/request/DataSourcesRequest;->zzast:Ljava/util/List;
...
.method public zzsY()Z
    ...
    iget-boolean v0, p0, Lcom/google/android/gms/fitness/request/DataSourcesRequest;->zzasu:Z
